...
class DataCollatorParlerTTSWithPadding:
    ...
    def __call__(self, features: List[Dict[str, Union[List[int], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
        ...
        # Hardy: Add emotion labels and other metadata if present, mainly for evaluation
        # metadata_fields = ["emotion", "gender", "background_noise", "pitch", "rate", "test_category", "number"]
        # Hardy: I cried.
